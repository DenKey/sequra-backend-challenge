...
ActiveRecord::Schema[7.1].define(version: 20_231_031_225_848) do
  ...
  create_table 'disbursements', force: :cascade do |t|
    ...
    t.index %w[operated_at merchant_id fee_type], name: 'idx_on_operated_at_merchant_id_fee_type_f88fafd7e1',
                                                  unique: true
